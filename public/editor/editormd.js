...
;(function(factory) {
    ...
    editormd.defaults     = {
        ...
        editorTheme          : "material",     // Editor area, this is CodeMirror theme at v1.5.0
        previewTheme         : "",             // Preview area theme, default empty
        markdown             : "",             // Markdown source code
        appendMarkdown       : "",             // if in init textarea value not empty, append markdown to textarea
        width                : "100%",
        height               : "99vh",
        path                 : location.protocol + "//" + location.hostname + "/editor/lib/",       // Dependents module file directory
        pluginPath           : location.protocol + "//" + location.hostname + "/editor/plugins/",   // If this empty, default use settings.path + "../plugins/"
        delay                : 300,            // Delay parse markdown to html, Uint : ms
        autoLoadModules      : true,           // Automatic load dependent module files
        watch                : true,
        placeholder          : "Create some Empress markdown!",
        gotoLine             : true,
        codeFold             : true,
        autoHeight           : false,
		autoFocus            : true,
    ...
    editormd.prototype    = editormd.fn = {
        ...
        init : function (id, options) {
            ...
            settings.onfullscreen = function() {
                editor.css("z-index", 5000);
            };

            settings.onfullscreenExit = function() {
         ...
         * 
         * @returns {Mixed} odeMirror setting option value
         */
        ...
        previewing : function() {
            ...
            if (codeMirror.css("display") === "none") // Zepto，codeMirror.is(":hidden")
            {
     ...
     * 
     * @param   {Array}    markdownToC
     * @returns {Renderer} markedRenderer
     */
